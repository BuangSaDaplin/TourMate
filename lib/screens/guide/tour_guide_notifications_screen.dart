...
class TourGuideNotificationsScreen extends StatefulWidget {
  const TourGuideNotificationsScreen({super.key});

  @override
  State<TourGuideNotificationsScreen> createState() =>
      _TourGuideNotificationsScreenState();
}

class _TourGuideNotificationsScreenState
    extends State<TourGuideNotificationsScreen> {
